 ...
 */
@Theme("reindeer")
public class StepperDemoRoot extends Root {
    ...
    private Panel getUpperPanel() {
        ...
        minValue.addListener(new Property.ValueChangeListener() {
        ...
        maxValue.addListener(new Property.ValueChangeListener() {
        ...
        manualInput.addListener(new ValueChangeListener() {
        ...
        mousewheelEnabled.addListener(new ValueChangeListener() {
        ...
        invalidValuesAllowed.addListener(new ValueChangeListener() {
    ...
    protected Layout getStepperLayout(final AbstractStepper<?, ?> stepper) {
        ...
        valueLabel.setContentMode(Label.ContentMode.XHTML);
